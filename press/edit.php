...
<?php echo $al->file('ccm-b-file', 'featureImage', t('Choose an Image'), $img); ?>

<?php echo $form->label('pressHeadline', 'Feature Headline');?>
<?php echo $form->textarea('pressHeadline', $pressHeadline, array());?>

<?php echo $form->label('pressReview', 'Review');?>
<?php echo $form->textarea('pressReview', $pressReview, array());?>
